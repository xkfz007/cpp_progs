...
char *fx_small_strptime(const char *p, const char *fmt, struct tm *dt)
{
    int c, val;
 ...
 */
int fx_parse_time(int64_t *timeval, const char *timestr, int duration)
{
    const char *p, *q;
    int64_t t, now64;
    time_t now;
