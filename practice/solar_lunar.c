...
int main(int argc, char*argv[])
{
    ...
    //for(int i=1987;i<2099;i+=19){
    //    for(int j=i;j<2099;j+=46){
    //        hjz osolar={
    //            .year = j,
    //            .month = 12,
    //            .day = 2,
    //        };
    //        hjz lunar = toLunar(osolar);
    //        printf("%d-%d-%d => %4d-%2d-%2d\n",osolar.year,osolar.month,osolar.day
    //                ,lunar.year,lunar.month,lunar.day);
    //    }
    //    printf("\n");

    //}
    for(int i=1987;i<2099;i+=1){
        hjz osolar={
            .year = i,
            .month = 12,
            .day = 2,
        ...
        hjz lunar = toLunar(osolar);
        if(lunar.month==10&&lunar.day==12)
    ...
    for(int i=1987;i<2099;i+=1){
        ...
        hjz lunar = toLunar(osolar);
        if(lunar.month==6&&lunar.day==11)
            printf("%04d-%02d-%02d => %4d-%02d-%02d\n",osolar.year,osolar.month,osolar.day
                    ,lunar.year,lunar.month,lunar.day);
    }
    return 0;
}
